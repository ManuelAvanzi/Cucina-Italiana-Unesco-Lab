...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "data:", "*.openstreetmap.org", "*.tile.openstreetmap.org", "i.ytimg.com", "img.youtube.com", "images.unsplash.com", "plus.unsplash.com"],
...
// SPA fallback for dashboard and admin
