...
function initDatabase() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS contenuti (
      ...
      sezione TEXT NOT NULL CHECK(sezione IN ('artusi','campanello','storie','generale','arte','stagionalita','leggende','letteratura','antiquarium','paesaggio')),
  ...
  if (contenutiSchema && !contenutiSchema.sql.includes("'paesaggio'")) {
    db.exec(`
    ...
    `);
    console.log('Migration: aggiunte tutte le sezioni tematiche al CHECK constraint di contenuti.');
  }
